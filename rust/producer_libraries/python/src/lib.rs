...
impl From<toypsqueue::common::submission::SubmissionStatus> for SubmissionStatus {
    fn from(value: toypsqueue::common::submission::SubmissionStatus) -> Self {
        use toypsqueue::common::submission::SubmissionStatus::*;
        match value {
