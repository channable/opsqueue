...
use http::Uri;
use tokio::{select, sync::{mpsc, oneshot, Mutex}, task::{yield_now, AbortHandle, JoinHandle}};
...
pub struct Client {
    ...
    // tx: mpsc::UnboundedSender<Envelope<ClientToServerMessage>>,
...
impl Client {
    pub async fn new(url: &str) -> anyhow::Result<Self> {
        ...
        // let (tx, mut rx) = mpsc::unbounded_channel::<Envelope<ClientToServerMessage>>();
